                ...
                <div class="p-6 text-white">
                    @if (Auth::user()->recomendation == 0)
                        <a
                            ...
                            class="rounded-md mb-2 row px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                        >
                    ...
                    @if (Auth::user()->recomendation != 0)
                        ...
                        @csrf
                                ...
                                <button type="submit" class="rounded-md w-100 row justify-content-center px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
