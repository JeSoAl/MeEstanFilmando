<div class="row d-flex mb-3 justify-content-center">
    <form class="search-form col-12" action="{{ route('films.index') }}" method="GET">
      <div class="d-flex row justify-content-center align-items-center">
        ...
        <div class="mx-2 col-12">
          <input type="text" name="title" id="title" class="form-control input-lg rounded-pill col-12" placeholder="Indique aquí el título la película o saga" />
        </div>
      </div>
      <div class="d-flex row justify-content-center align-items-center">
