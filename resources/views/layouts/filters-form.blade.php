<x-admin-card>
  ...
  <div id="card5" class="d-none">
    ...
    <div id="falseDirectors">
        ...
        <button type="button" class="btn btn-dark w-s" onclick="addFalseDirector()">
            <img src="/pictures/icons/plus.png" width="15">
        </button>
    </div>

    <div id="falseActors">
        <label class="form-label">¿Hay algún actor o alguna actriz que preferirías no ver?</label>
        <button type="button" class="btn btn-dark w-s" onclick="addFalseActor()">
            <img src="/pictures/icons/plus.png" width="15">
        </button>
    </div>
    <div class="ms-auto row justify-content-between">
...
<script>
    ...
    function fourthCard() {
        const element5 = document.getElementById("card5");  
        element5.classList.remove("d-block"); 
    ...
    let totalTrueDirectors = 0;
    let totalFalseDirectors = 0;
    let totalTrueActors = 0;
    let totalFalseActors = 0;
    var trueDirectors = document.querySelectorAll(".trueDirector");
    var falseDirectors = document.querySelectorAll(".falseDirector");
    var trueActors = document.querySelectorAll(".trueActor");
    var falseActors = document.querySelectorAll(".falseActor");
    let trueDirectorCount = trueDirectors.length;
    let falseDirectorCount = falseDirectors.length;
    ...
    function addTrueDirector() {
        const trueDirectorHTML = `<div class="form-group mb-3 trueDirector" id="trueDirector`+ trueDirectorCount +`">
                                ...
                                <button type="button" class="btn btn-warning w-s" onclick="deleteTrueDirector(`+ trueDirectorCount +`)">
                                    <img src="/pictures/icons/delete.png" width="15">
                                </button>
                        </div>`;
        document.getElementById('trueDirectors').insertAdjacentHTML('beforeend', trueDirectorHTML);
        trueDirectorCount++;
    }
    ...
    function addFalseDirector() {
        const falseDirectorHTML = `<div class="form-group mb-3 falseDirector" id="falseDirector`+ falseDirectorCount +`">
                                ...
                                <button type="button" class="btn btn-warning w-s" onclick="deleteFalseDirector(`+ falseDirectorCount +`)">
                                    <img src="/pictures/icons/delete.png" width="15">
                                </button>
                        </div>`;
        document.getElementById('falseDirectors').insertAdjacentHTML('beforeend', falseDirectorHTML);
        falseDirectorCount++;
    }
    ...
    function addTrueActor() {
        const trueActorHTML = `<div class="form-group mb-3 trueActor" id="trueActor`+ trueActorCount +`">
                                ...
                                <button type="button" class="btn btn-warning w-s" onclick="deleteTrueActor(`+ trueActorCount +`)">
                                    <img src="/pictures/icons/delete.png" width="15">
                                </button>
                        </div>`;
        document.getElementById('trueActors').insertAdjacentHTML('beforeend', trueActorHTML);
        trueActorCount++;
    }
    ...
    function addFalseActor() {
        const falseActorHTML = `<div class="form-group mb-3 falseActor" id="falseActor`+ falseActorCount +`">
                                ...
                                <button type="button" class="btn btn-warning w-s" onclick="deleteFalseActor(`+ falseActorCount +`)">
                                    <img src="/pictures/icons/delete.png" width="15">
                                </button>
                        </div>`;
        document.getElementById('falseActors').insertAdjacentHTML('beforeend', falseActorHTML);
        falseActorCount++;
    }

    function deleteTrueDirector(trueDirectorCount) {
        let node = document.getElementById("trueDirector"+trueDirectorCount);
        node.remove();
    }

    function deleteFalseDirector(falseDirectorCount) {
        let node = document.getElementById("falseDirector"+falseDirectorCount);
        node.remove();
    }

    function deleteTrueActor(trueActorCount) {
        let node = document.getElementById("trueActor"+trueActorCount);
        node.remove();
    }

    function deleteFalseActor(falseActorCount) {
        let node = document.getElementById("falseActor"+falseActorCount);
        node.remove();
    }
</script>