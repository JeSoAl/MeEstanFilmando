        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white">
                  <x-header-title  :title="'Modificar los datos del director ' . $director->id" subtitle="" :links="[]">
                  </x-header-title>

                  <form action="{{ route('admin.directors.update', ['director' => $director]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                          <x-admin-card>
                            ...
                            @include('admin.directors.partials.buttons')
                          </x-admin-card>
                        </div>
                    </div>
                  </form>
