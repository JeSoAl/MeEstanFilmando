...
class FilmController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('films.index', compact('films', 'genres', 'awards', 'actors', 'directors', 'platforms', 'request'));
    }
    ...
    public function create()
    {
        ...
        $platforms = Platform::all();
        $film = new Film();
        return view('films.create', compact('film', 'genres', 'actors', 'awards', 'directors', 'platforms'));
    }
    ...
    public function show(Film $film)
    {
        ...
        return view('films.show', compact('film', 'genres', 'actors', 'awards', 'directors', 'platforms', 'filmGenres', 'filmActors', 'filmAwards', 'filmPlatforms'));
    }
